...
code = code.replace(
  ...
  "dersleri_yerleştir: (preparedState: AppState, keepExisting: boolean, targets?: { classIds?: string[], teacherIds?: string[] }, extraOpts?: { deepSearch?: boolean, numTrials?: number, maxDurationMs?: number }) => Promise<any>;"
);
code = code.replace(
